...
#mzwu nutsack audio outputs for final project
#set_property PACKAGE_PIN B13 [get_ports {output_pwm[0]}]
#set_property PACKAGE_PIN B14 [get_ports {output_pwm[1]}]


#set_property PACKAGE_PIN B13 [get_ports {SPKL}]
#set_property IOSTANDARD LVCMOS33 [get_ports {output_pwm[0]}]

#set_property PACKAGE_PIN B14 [get_ports {SPKR}]
#set_property IOSTANDARD LVCMOS33 [get_ports {output_pwm[1]}]
