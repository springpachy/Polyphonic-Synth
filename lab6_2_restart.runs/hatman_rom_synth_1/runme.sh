...
HD_PWD='C:/Users/srira/OneDrive/Desktop/ECE385/ECE385-sanjits2_mzwu3/lab6_2_restart/lab6_2_restart.runs/hatman_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hatman_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hatman_rom.tcl
