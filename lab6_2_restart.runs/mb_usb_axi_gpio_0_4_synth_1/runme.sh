...
HD_PWD='C:/Users/Matthew/Documents/VivadoStuff/lab6_2_restart/lab6_2_restart.runs/mb_usb_axi_gpio_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_usb_axi_gpio_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_usb_axi_gpio_0_4.tcl
