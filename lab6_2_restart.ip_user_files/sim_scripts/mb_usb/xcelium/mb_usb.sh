...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../lab6_2_restart.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../lab6_2_restart.gen/sources_1/bd/mb_usb/ipshared/7698" \
       +incdir+"../../../../lab6_2_restart.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"../../../../lab6_2_restart.gen/sources_1/bd/mb_usb/ipshared/7698" \
       -input simulate.do
}
